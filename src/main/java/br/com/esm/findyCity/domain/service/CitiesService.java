...
//        final List<City> cities = citiesRepository.findAllById((Arrays.asList(city1, city2)));
...
//        return citiesRepository.distanceByPoints(city1, city2);
//    }
...
//        Point p2 = cities.get(1).getLocation();
//
//        return citiesRepository.distanceByCube(p1.getX(), p1.getY(), p2.getX(), p2.getY());
//    }
